declare namespace twgl {
    ...
    export function createBufferInfoFromArrays(gl: WebGLRenderingContext, arrays: Arrays|{ [x: string]: twgl.ArraySpec }): BufferInfo;
    ...
    export function setAttribInfoBufferFromArray(gl: WebGLRenderingContext, attribInfo: AttribInfo, array: ArraySpec|Arrays, offset?: number): void;
    ...
    export function setTextureFromArray(gl: WebGLRenderingContext, tex: WebGLTexture, src: number[] | ArrayBuffer|ArrayBufferView, options?: TextureOptions): void;
    ...
    export interface Arrays {
        [key: string]: number[] | ArrayBuffer|ArrayBufferView
    }
    ...
    export type ArraySpec = number[] | ArrayBuffer | FullArraySpec|ArrayBufferView;
    ...
    export type FullTextureSrc = number[] | ArrayBuffer | HTMLCanvasElement | HTMLImageElement | HTMLVideoElement | string | string[] | TextureFunc|ArrayBufferView;
    ...
    export interface TextureOptions {
        ...
        color?: number[] | ArrayBuffer|ArrayBufferView;
        auto?: boolean;
