...
The application allows you to get an accurate representation of the model through interactive parameters. But it is now easier to use advanced 3D software to fine tune the appearance of the outputs.

Most of the operations described below consist in _cleaning_ the three dimensional geometries generated by the app.
